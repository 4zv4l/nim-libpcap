...
# Modified version of https://github.com/praetoriannero/libpcap/blob/main/src/libpcap.nim
# Without the `echo("X OS detected")`
...
proc pcapLookupDev*(buffer: cstring): cstring
    {.importc: "pcap_lookupdev".}

proc pcapLookupNet*(device: cstring, net: var cuint, mask: var cuint, errorBuf: cstring): cint
    {.importc: "pcap_lookupnet".}

proc pcapCreate*(source: cstring, errorBuf: cstring): Pcap
    {.importc: "pcap_create".}
...
proc pcapOpenLive*(device: cstring, snapLen: cint, promisc: cint, toMs: cint, errorBuf: cstring): Pcap
...
proc pcapOpenOfflineWithTstampPrecision*(fname: cstring, errorBuf: cstring): Pcap
    {.importc: "pcap_open_offline_with_tstamp_precision".}

proc pcapOpenOffline*(fname: cstring, errorBuf: cstring): Pcap
    {.importc: "pcap_open_offline".}

proc pcapFopenOffline*(filePointer: File, errorBuf: cstring): Pcap
    {.importc: "pcap_fopen_offline".}

proc pcapFopenOfflineWithTstampPrecision*(filePointer: File, precision: cuint, errorBuf: cstring): Pcap
...
proc pcapGetNonblock*(handle: Pcap, errorBuf: cstring): cint
    {.importc: "pcap_getnonblock".}

proc pcapSetNonblock*(handle: Pcap, nonblock: cint, errorBuf: cstring): cint
...
when defined(Windows):
    ...
    proc pcapStartOem*(errorBuf: cstring, flags: cint): cint
...
proc pcapOpen*(source: cstring, snapLen: cint, flags: cint, readTimeout: cint, auth: PcapRmtAuth, errorBuf: cstring): Pcap
    {.importc: "pcap_open".}

proc pcapCreateSrcStr*(source: cstring, srcType: cint, host: cstring, port: cstring, name: cstring, errorBuf: cstring): cint
    {.importc: "pcap_createsrcstr".}

proc pcapParseSrcStr*(source: cstring, srcType: cint, host: cstring, port: cstring, name: cstring, errorBuf: cstring): cint
    {.importc: "pcap_parsesrcstr".}

proc pcapFindAllDevsEx*(source: cstring, auth: PcapRmtAuth, alldevs: var PcapIf, errorBuf: cstring): cint
    {.importc: "pcap_findalldevs_ex".}

proc pcapSetSampling*(handle: Pcap): PcapSamp
    {.importc: "pcap_setsampling".}

proc pcapRemoteActAccept*(address: cstring, port: cstring, hostlist: cstring, connectingHost: cstring, auth: var PcapRmtAuth, errorBuf: cstring): Socket
    {.importc: "pcap_remoteact_accept".}

proc pcapRemoteActAcceptEx*(address: cstring, port: cstring, hostlist: cstring, connectingHost: cstring, auth: var PcapRmtAuth, usesSSL: cint, errorBuf: cstring): Socket
    {.importc: "pcap_remoteact_accept".}

proc pcapRemoteActList*(hostList: cstring, sep: char, size: cint, errorBuf: cstring): cint
    {.importc: "pcap_remoteact_list".}

proc pcapRemoteActClose*(host: cstring, errorBuf: cstring): cint
